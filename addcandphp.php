...
$sql="insert into candidate(symbolid,candidateid,name,sex,age,locationid) values('$_POST[symbolid]','$_POST[candidateid]','$_POST[name]','$_POST[sex]','$_POST[age]','$_POST[locationid]')";
